...
export async function GET() {
  ...
  const url = `https://www.alphavantage.co/query?function=NEWS_SENTIMENT&topics=technology,ipo,economy,markets,mergers_and_acquisitions&limit=2&apikey=${apiKey}`;
